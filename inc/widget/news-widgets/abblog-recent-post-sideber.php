 ...
 * @since 1.0.0
*/
class Abblog_recent_post_sideber extends WP_Widget 
{

    public function __construct() 
    {
        parent::__construct(
            'widget_recent_post_sideber', 
            _x( 'AB Recent Post Sideber', 'Category Posts Widget' ), 
            [ 'description' => __( 'Display a list of posts from a selected category.' ) ] 
        );
        $this->alt_option_name = 'widget_recent_post_sideber';
    ...
    public function widget( $args, $instance ) 
    {
        ...
        if( $q->have_posts() ) { ?>
                    ...
                    <div class="widget-tab widget pd-top-70">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="widget-pill-01">
                                ...
                                <div class="media-post-wrap media">
                                    ...
                                    <div class="media-body">
                                        <?php  
                                            ...
                                            if ( ! empty( $categories ) ) {
                                                echo '<a class="tag text-red" href="' . esc_url( get_category_link( $categories[0]->term_id ) ) . '">' . esc_html( $categories[0]->name ) . '</a>';
                                            }
                                        ?> 
                                        <div class="meta">
                                            <div class="date">
