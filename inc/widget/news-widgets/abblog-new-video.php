 ...
 * @since 1.0.0
*/
class Abblog_news_video extends WP_Widget 
{
    ...
    public function __construct() 
    {
        parent::__construct(
            'widget_news_video', 
            _x( 'AB Full: New Video', 'Category Posts Widget' ), 
            [ 'description' => __( 'Display a list of posts from a selected category.' ) ] 
        );
        $this->alt_option_name = 'widget_news_video';
    ...
    public function widget( $args, $instance ) 
    {
        ...
        if( $q->have_posts() ) { ?>
            ...
            <div class="video-area bg-main pd-top-70 pd-bottom-80">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="top-post-wrap-4">
                                ...
                                <div class="top-post-details">
                                    ...
                                    <div class="meta">
                                        ...
                                        <div class="right-side-meta ms-auto">
                                            <a href="#" class="like">
