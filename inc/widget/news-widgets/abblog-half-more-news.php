 ...
 * @since 1.0.0
*/
class Abblog_half_more_news extends WP_Widget 
{

    public function __construct() 
    {
        parent::__construct(
            'widget_half_more_news', 
            _x( 'AB Half More News', 'Category Posts Widget' ), 
            [ 'description' => __( 'Display a list of posts from a selected category.' ) ] 
        );
        $this->alt_option_name = 'widget_half_more_news';
