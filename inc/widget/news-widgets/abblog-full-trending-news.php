 ...
 * @since 1.0.0
*/
class Abblog_full_trending_news extends WP_Widget 
{

    public function __construct() 
    {
        parent::__construct(
            'widget_full_trending_news', 
            _x( 'AB Full Trending News', 'Category Posts Widget' ), 
            [ 'description' => __( 'Display a list of posts from a selected category.' ) ] 
        );
        $this->alt_option_name = 'widget_full_trending_news';
    ...
    public function widget( $args, $instance ) 
    {
        ...
        if( $q->have_posts() ) { ?>
            ...
            <!-- trending-area Start -->
            <div id="<?php the_ID(); ?>" class="pd-bottom-30">
                <div class="container">
                <div class="section-title">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="trending-post-slider owl-carousel">
                                    ...
                                    <div class="single-post-wrap">
                                        ...
                                        <?php the_post_thumbnail('medium'); ?>
                                            <?php  $categories = get_the_category();
                                                if ( ! empty( $categories ) ) {
                                                    echo '<a class="tag top-right tag-sky" href="' . esc_url( get_category_link( $categories[0]->term_id ) ) . '">' . esc_html( $categories[0]->name ) . '</a>';
                                                }
                                                ?> 
                                        </div>
