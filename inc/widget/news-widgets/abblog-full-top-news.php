 ...
 * @since 1.0.0
*/
class Abblog_full_top_news extends WP_Widget 
{

    public function __construct() 
    {
        parent::__construct(
            'widget_full_top_news', 
            _x( 'AB Full Top News', 'Category Posts Widget' ), 
            [ 'description' => __( 'Display a list of posts from a selected category.' ) ] 
        );
        $this->alt_option_name = 'widget_full_top_news';
    ...
    public function widget( $args, $instance ) 
    {
        ...
        if( $q->have_posts() ) { ?>
            ...
            <div id="<?php the_ID(); ?>" class="top-news-area pd-top-30">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="recent-post-slider owl-carousel">
