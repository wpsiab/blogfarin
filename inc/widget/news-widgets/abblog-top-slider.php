 ...
 * @since 1.0.0
*/
class Abblog_top_slider extends WP_Widget 
{
    ...
    public function __construct() 
    {
        parent::__construct(
            'widget_top_slider', 
            _x( 'AB Full Top Slider', 'Category Posts Widget' ), 
            [ 'description' => __( 'Display a list of posts from a selected category.' ) ] 
        );
        $this->alt_option_name = 'widget_top_slider';
                            ...
                            <div class="item">
                                <div class="top-post-wrap top-post-wrap-4">
                                    ...
                                    <div class="top-post-details">
                                        ...
                                        <h4><a href="<? the_permalink(); ?>"><?php esc_html( the_title() ) ?></a></h4>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="top-post-wrap">
                                    <div class="thumb">
                                        ...
                                        <?php  
                                            $categories = get_the_category();
                                            if ( ! empty( $categories ) ) {
                                                echo '<a class="tag top-right tag-purple" href="' . esc_url( get_category_link( $categories[0]->term_id ) ) . '">' . esc_html( $categories[0]->name ) . '</a>';
                                            }
                                        ?> 
