 ...
 * @since 1.0.0
*/
class Abblog_covid_news extends WP_Widget 
{
    ...
    public function __construct() 
    {
        parent::__construct(
            'widget_covid_news', 
            _x( 'AB Full Covid News', 'Category Posts Widget' ), 
            [ 'description' => __( 'Display a list of posts from a selected category.' ) ] 
        );
        $this->alt_option_name = 'widget_covid_news';
    ...
    {
        $post_no = !empty( $instance[ 'post_no' ] ) ? $instance[ 'post_no' ] : 7;
        $cache = [];
        if ( ! $this->is_preview() ) {
            ...
            <div class="media-post-wrap-2 media">
                ...
                <div class="media-body">
                    ...
                    <?php  
                        ...
                        if ( ! empty( $categories ) ) {
                            echo '<a class="tag tag-purple" href="' . esc_url( get_category_link( $categories[0]->term_id ) ) . '">' . esc_html( $categories[0]->name ) . '</a>';
                        }
                    ?> 
                ...
                <div class="col-lg-6">
                    <div class="media-post-wrap-3 media">
                        ...
                        <div class="media-body">
                            ...
                            <h6><a href="<?php the_permalink(); ?>"><?php esc_html( the_title() ) ?></a></h6>
                        </div>
                    </div>
                </div>
                <?php
