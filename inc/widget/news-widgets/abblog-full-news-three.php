 ...
 * @since 1.0.0
*/
class Abblog_full_news_three extends WP_Widget 
{

    public function __construct() 
    {
        parent::__construct(
            'widget_full_news_three', 
            _x( 'AB Full News Three', 'Category Posts Widget' ), 
            [ 'description' => __( 'Display a list of posts from a selected category.' ) ] 
        );
        $this->alt_option_name = 'widget_full_news_three';
    ...
    public function widget( $args, $instance ) 
    {
        ...
        if( $q->have_posts() ) { ?>
        <!-- editors-area Start -->
        <div id="<?php the_ID(); ?>"  class="editors-area bg-gray pd-top-70 pd-bottom-50">
                <div class="container">
